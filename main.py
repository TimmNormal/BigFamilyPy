...
class BigFamaly(App):
	...
	def moreInformation(self,i):
		...
		self.moreInfoActivity = DopActivity(name = "moreInformation",title = i.title,content = i.description,type = i.type,avatar = i.avatar,login = "Lol",reputation = i.reputation,deadline = i.deadline,userId = i.userId,selfUserID = self.USER_ID,blockId = i.blockId)
	...
	def loadsActivity(self):
		...
		self.moreInfoActivity = DopActivity(title = "",content = "",type = "",avatar = "",login = "",reputation = "",deadline = "",userId = "",selfUserID = "",blockId = "")
	...
	def createDialog(self,istance):
		cD = requests.post("http://timmcool.pythonanywhere.com",json = {})
